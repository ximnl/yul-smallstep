chapter \<open>Generated by Lem from lem/word256.lem.\<close>
...
(*val size256 : integer*)
definition size256  :: " int "  where 
     " size256 = (( 2 :: int) ^( 256 :: nat))"
...
(*let word256ToNatural w=  naturalFromInteger ((Instance_Num_NumRemainder_Num_integer.mod) (word256ToInteger w) size256)*)
...
definition word256FromNatural  :: " nat \<Rightarrow> 256 word "  where 
     " word256FromNatural i = ( (\<lambda> i .  word_of_int ( i)) (int i))"
...
(*let word256UGT a b=  (Instance_Basic_classes_Ord_Num_natural.>) (word256ToNatural a) (word256ToNatural b)*)

(*val word256ULT : word256 -> word256 -> bool*)
(*let word256ULT a b=  (Instance_Basic_classes_Ord_Num_natural.<) (word256ToNatural a) (word256ToNatural b)*)

(*val word256UGE : word256 -> word256 -> bool*)
(*let word256UGE a b=  (Instance_Basic_classes_Ord_Num_natural.>=) (word256ToNatural a) (word256ToNatural b)*)

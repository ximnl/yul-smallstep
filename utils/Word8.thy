chapter \<open>Generated by Lem from lem/word8.lem.\<close>
...
(*let word8ToNat w=  natFromInt ((Instance_Num_NumRemainder_Num_int.mod) (intFromInteger (integerFromBitSeq (w8_to_bs w))) 256)*)

(*val word8ToNatural : word8 -> natural*)
(*let word8ToNatural w=  naturalFromInt ((Instance_Num_NumRemainder_Num_int.mod) (intFromInteger (integerFromBitSeq (w8_to_bs w))) 256)*)
...
definition word8FromNatural  :: " nat \<Rightarrow> 8 word "  where 
     " word8FromNatural i = ( (\<lambda> i .  word_of_int ( i)) (int i))"
